...
output "docker" {
  value = [ aws_instance.docker-enginer.public_ip, aws_instance.docker-enginer.private_ip ]
}

output "Web-Server" {
  value = [ aws_instance.Web-Server.public_ip, aws_instance.Web-Server.private_ip ]
}*/